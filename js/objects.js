...
function Person(firstName, lastName, age, gender, address, interests) {
    this.name = {
      first: firstName,
      last: lastName
    };
    ...
    this.bio = function() {
      return `${this.name.first} ${this.name.last} is ${this.age} years old. They live at ${this.address}. They like ${this.interests.join(', ')}.`;
    };
...
person.describe = function () {
    ...
    alert(`${this.name.firstName} is ${this.age} years old. They identify as ${this.gender}. Their interests include: ${interestsStr}.`);
};
...
person.bio = function () {
    return `${this.name.firstName}, aged ${this.age}, identifies as ${this.gender}. Interests include ${this.interests.join(', ')}.`;
};
...
// Update the greeting function to use the sub-namespace 'name'
...
person.bio = function () {
    return `${this.name.firstName} ${this.name.lastName}, aged ${this.age}, identifies as ${this.gender}. Interests include ${this.interests.join(', ')}.`;
};
...
console.log(person['address']['streetNo']); 
